/*!
    ...
    \brief The chain_prompt_decoder_no_iir chain.
...
const chain_config_t chain_prompt_decoder_no_iir_config_p0 = {0, 0, operators_p0, 2, inputs, 1, outputs, 1, connections, 1};

const chain_config_t chain_prompt_decoder_no_iir_config_p1 = {0, 0, operators_p1, 2, inputs, 1, outputs, 1, connections, 1};
