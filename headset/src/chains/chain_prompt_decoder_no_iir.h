...
/*!
\page chain_prompt_decoder_no_iir
@startuml
...
extern const chain_config_t chain_prompt_decoder_no_iir_config_p0;

extern const chain_config_t chain_prompt_decoder_no_iir_config_p1;
