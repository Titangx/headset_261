/*!
    ...
    \file chain_output_volume_no_passthrough.c
...
#include <chain_output_volume_no_passthrough.h>
...
static const operator_config_t operators[] =
{
    ...
    MAKE_OPERATOR_CONFIG(HS_CAP_ID_VOL_CTRL_VOL, OPR_VOLUME_CONTROL),
} ;
...
const chain_config_t chain_output_volume_no_passthrough_config = {0, 0, operators, 2, inputs, 2, outputs, 1, connections, 1};
