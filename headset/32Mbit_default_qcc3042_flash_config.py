...

{
    ...
    "layout": [
        ...
        ("apps_p1",         {"capacity": 208 * 4 * 1024,  "authenticate": True, "src_file_signed": True}),
        ...
        ("ro_cfg_fs",       {"capacity":  56 * 4 * 1024,  "authenticate": False}),
        ("ro_fs",           {"capacity":  68 * 4 * 1024,  "authenticate": False})
    ]
}
