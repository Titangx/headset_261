...
#define HCI_MAX_ULP_OCF                                   ((hci_op_code_t)0x0076)
...
#define HCI_ULP_SET_CIG_PARAMETERS_PARAM_LEN                        ((uint8_t) 12) /* Variable */
...
#define HCI_EV_MASK_ULP_BIGINFO_ADV_REPORT_LO                  HCI_EV_MASK_HI(HCI_EV_ULP_BIGINFO_ADV_REPORT)
...
#define HCI_ULP_EXT_ADV_2M_PHY           ((uint8_t)0x02)
 ...
 *     These commands are not for Applications.
 *----------------------------------------------------------------------------*/
#define HCI_ISOC_CHANNEL_HOST_SUPPORT_FEATURE        (0x20)
