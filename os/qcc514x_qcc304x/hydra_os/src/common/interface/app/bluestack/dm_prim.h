...
typedef struct
{
    ...
    phandle_t                 phandle;
    uint8_t                   scan_handle;
    bool_t                    scan_handle_unregistered;
...
#define DM_ULP_ADV_SCAN_API_LEGACY 1
#define DM_ULP_ADV_SCAN_API_EXTENDED 2
#define DM_ULP_ADV_SCAN_API_PERIODIC 4
#define DM_ULP_ADV_SCAN_API_PAST_SENDER 8
#define DM_ULP_ADV_SCAN_API_PERIODIC_RECIPIENT 16
...
typedef struct
{
    ...
    phandle_t       phandle;       /* destination phandle */
    hci_return_t    status;
    uint8_t         available_api;
    uint8_t         available_adv_sets;
    uint8_t         stack_reserved_adv_sets;
    uint8_t         max_periodic_sync_list_size;
    uint16_t        supported_phys;
    uint16_t        max_potential_size_of_tx_adv_data;
    uint16_t        max_potential_size_of_tx_periodic_adv_data;
    uint16_t        max_potential_size_of_rx_adv_data;
    uint16_t        max_potential_size_of_rx_periodic_adv_data;
} DM_ULP_GET_ADV_SCAN_CAPABILITIES_CFM_T;
 ...
 * in BT5.1: command = LE Set Extended Advertising Parameters Command.
 *
 * RETURNS
 ...
 * BT5.1: command = LE Set Extended Advertising Enable Command
 *
 * RETURNS
...
typedef struct
{
    ...
    uint8_t            enable;   /* Start/stop advertising */
 ...
 * random address or write a generated random address. Types of addresses that can be
 * generated and written are Static, Resolvable Private Address (RPA) and
...
typedef struct
{
    ...
    phandle_t                   phandle;                      /* Destination phandle */
    hci_return_t                status;                      /* HCI_SUCCESS or error */
    uint8_t                     adv_handle;                       /* Advertising set */
 ...
 * PURPOSE
 *
 * Start or stop scanners scanning.
 *
 * RETURNS
...
typedef struct
{
    ...
    phandle_t       phandle;       /* destination phandle */
    hci_return_t    status;
    uint8_t         num_of_enabled_scanners;
    uint8_t         legacy_scanner_enabled;
    uint16_t        duration;
    uint16_t        scanning_phys;
    ES_SCANNING_PHY_T phys[DM_ULP_EXT_SCAN_MAX_SCANNING_PHYS];
} DM_ULP_EXT_SCAN_GET_CTRL_SCAN_INFO_CFM_T;
...
/*----------------------------------------------------------------------------*
 * PURPOSE
 *     DM_ULP_EXT_SCAN_CTRL_SCAN_INFO_IND
 *---------------------------------------------------------------------------*/
 ...
 * PURPOSE
 *
 * Configure how you wish the advertising set to periodic advertise.
 *
 * RETURNS
 ...
 *----------------------------------------------------------------------------*/
#define DM_PERIODIC_ADV_STOP_PA 0
#define DM_PERIODIC_ADV_STOP_EA_THEN_PA 1
#define DM_PERIODIC_ADV_STOP_EA 2

typedef struct
{
    dm_prim_t       type;                    /* DM_ULP_PERIODIC_ADV_STOP_REQ */
    uint8_t         adv_handle;
    uint8_t         stop_advertising;        /* PERIODIC_ADV_STOP_* */
 ...
 * PURPOSE
 *
 * Cancel establishing sync to a periodic train.
 *
 * RETURNS
 ...
 * PURPOSE
 *
 * Stop syncing to a periodic train.
 *
 * RETURNS
 ...
 *     
 *     Note: cis_handle will be arranged in same order as cis is configured.
 *---------------------------------------------------------------------------*/
 ...
 *
 *     Each CIS shall be configured using DM_ISOC_CONFIGURE_CIG_REQ before CIS
