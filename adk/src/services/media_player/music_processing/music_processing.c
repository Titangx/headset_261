...
#ifdef INCLUDE_GAIA
    if (user_eq_bands_set)
    {
        DEBUG_LOG_VERBOSE("MusicProcessing_SetUserEqBands, send gaia notification");
        MusicProcessingGaiaPlugin_BandGainsChanged((end_band - start_band + 1), start_band);
    }
#endif /* INCLUDE_GAIA */
