...
typedef uint16 service_handle_t;
...
/*
    ...
    @return service_handle_t unique handle to the new service data instance.
    If the handle is zero this indicates an initialisation failure.

*/
service_handle_t ServiceHandleNewInstance(void **newInstance, const uint16 newSize);
...
*/
void* ServiceHandleGetInstanceData(const service_handle_t service_handle);
...
*/
bool ServiceHandleFreeInstanceData(const service_handle_t service_handle);
