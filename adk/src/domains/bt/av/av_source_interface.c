...
const sep_config_type av_aptxad_src_sep     = {AV_SEID_APTX_ADAPTIVE_SRC,      ENCODE_RESOURCE_ID, sep_media_type_audio, a2dp_source, FALSE, 0, sizeof(aptx_adaptive_src_caps),  aptx_adaptive_src_caps};
