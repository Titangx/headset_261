...
enum
{
    ...
    AV_SEID_APTX_ADAPTIVE_SRC = 0x02,

    AV_SEID_SBC_SNK = 0x03,                 /*!< SBC Sink endpoint for standard handsets */
    AV_SEID_AAC_SNK = 0x04,                 /*!< AAC Sink endpoint for standard handsets */
    AV_SEID_APTX_SNK = 0x05,                /*!< APTX Sink endpoint for standard handsets */
    AV_SEID_APTXHD_SNK = 0x06,              /*!< APTX HD Sink endpoint for standard handsets */
    AV_SEID_APTX_ADAPTIVE_SNK = 0x07,       /*!< APTX adaptive Sink endpoint for standard handsets (placeholder) */

    AV_SEID_SBC_MONO_TWS_SRC = 0x08,        /*!< Mono TTP SBC Source endpoint for earbud forwarding TWS */
    AV_SEID_AAC_STEREO_TWS_SRC = 0x09,      /*!< Stereo TTP AAC Source endpoint for earbud forwarding TWS */
    AV_SEID_APTX_MONO_TWS_SRC = 0x0A,       /*!< Mono TTP APTX Source endpoint for earbud forwarding TWS  */
    AV_SEID_APTX_ADAPTIVE_TWS_SRC = 0x0B,   /*!< TTP APTX adaptive Source endpoint for earbud forwarding TWS (placeholder) */

    AV_SEID_SBC_MONO_TWS_SNK = 0x0C,        /*!< Mono TTP SBC Sink endpoint for peer earbud receiving TWS */
    AV_SEID_AAC_STEREO_TWS_SNK = 0x0D,      /*!< Stereo TTP AAC Sink endpoint for peer earbud receiving TWS */
    AV_SEID_APTX_MONO_TWS_SNK = 0x0E,       /*!< Mono TTP APTX Sink endpoint for peer earbud receiving TWS & TWS+ Handsets */
