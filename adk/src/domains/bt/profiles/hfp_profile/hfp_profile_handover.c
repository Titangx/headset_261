...
const marshal_type_info_t hfp_profile_marshal_types[] = {
	...
	MARSHAL_TYPE_INFO(hfp_link_prio_mapping_t, MARSHAL_TYPE_CATEGORY_GENERIC)
};
    ...
    *marshal_obj = NULL;
    ...
    if(NULL != instance)
    {
        switch (type)
        {
            ...
            case MARSHAL_TYPE(hfp_link_prio_mapping_t):
                *marshal_obj = &hfp_link_prio_mappings;
                status = TRUE;
                break;
                                 ...
                                 void *unmarshal_obj)
{
    ...
    switch (type)
    {
        ...
        case MARSHAL_TYPE(hfp_link_prio_mapping_t):
            {
                hfp_link_prio_mapping_t *map = (hfp_link_prio_mapping_t*)unmarshal_obj;
                memcpy(&hfp_link_prio_mappings, map, sizeof(hfp_link_prio_mapping_t));
                result = UNMARSHAL_SUCCESS_FREE_OBJECT;
            }
            break;
