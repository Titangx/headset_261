...
static void handleMessage(Task task, MessageId id, Message message)
{
    ...
    switch (id)
    {
        ...
        case CL_DM_BLE_EXT_ADVERTISE_ENABLE_CFM:
            DEBUG_LOG_LEVEL_1("CL_DM_BLE_EXT_ADVERTISE_ENABLE_CFM");
        ...
        case CL_DM_BLE_SET_EXT_ADV_DATA_CFM:
            DEBUG_LOG_LEVEL_1("CL_DM_BLE_SET_EXT_ADV_DATA_CFM");
        ...
        case CL_DM_BLE_EXT_ADV_SET_SCAN_RESPONSE_DATA_CFM:
            DEBUG_LOG_LEVEL_1("CL_DM_BLE_EXT_ADV_SET_SCAN_RESPONSE_DATA_CFM");
        ...
        case CL_DM_BLE_SET_EXT_ADV_PARAMS_CFM:
            DEBUG_LOG_LEVEL_1("CL_DM_BLE_SET_EXT_ADV_PARAMS_CFM");
        ...
        case CL_DM_BLE_EXT_ADV_REGISTER_APP_ADV_SET_CFM:
            DEBUG_LOG_LEVEL_1("CL_DM_BLE_EXT_ADV_REGISTER_APP_ADV_SET_CFM");
        ...
        case LE_ADV_MGR_INTERNAL_DATA_UPDATE:
            DEBUG_LOG_LEVEL_1("LE_ADV_MGR_INTERNAL_DATA_UPDATE");
            leAdvertisingManager_HandleInternalDataUpdateRequest();
            break;

        case LE_ADV_MGR_INTERNAL_ENABLE_CONNECTABLE:
            DEBUG_LOG_LEVEL_1("LE_ADV_MGR_INTERNAL_ENABLE_CONNECTABLE");
        ...
        case LE_ADV_MGR_INTERNAL_ALLOW_ADVERTISING:
            DEBUG_LOG_LEVEL_1("LE_ADV_MGR_INTERNAL_ALLOW_ADVERTISING");
        ...
        case LE_ADV_MGR_INTERNAL_RELEASE_DATASET:
            DEBUG_LOG_LEVEL_1("LE_ADV_MGR_INTERNAL_RELEASE_DATASET");
        ...
        case LE_ADV_MGR_INTERNAL_PARAMS_UPDATE:
            DEBUG_LOG_LEVEL_1("LE_ADV_MGR_INTERNAL_PARAMS_UPDATE");
...
static bool leAdvertisingManager_InternalEnableConnectableAdvertising(Task task, bool enable)
{
...
static bool leAdvertisingManager_InternalAllowAdvertising(Task task, bool allow)
{
    task_allow_all = task;
...
/* Local function to restart advertising with parameters update*/
static void leAdvertisingManager_ScheduleInternalAdvertisingStartWithParamsUpdate(void)
{
...
static void leAdvertisingManager_HandleInternalParametersUpdateRequest(void)
{
    leAdvertisingManager_ScheduleInternalAdvertisingStartWithParamsUpdate();
    
}
     
/* Local function to check if data update is in progress while advertising */
static bool leAdvertisingManager_IsDataUpdateInProgressWhileAdvertising(void)
{
    DEBUG_LOG_LEVEL_1("leAdvertisingManager_IsDataUpdateInProgressWhileAdvertising");
    ...
    if(LeAdvertisingManagerSm_IsAdvertisingStarted())
    {
        if(   leAdvertisingManager_CheckBlockingCondition(ADV_SETUP_BLOCK_ADV_DATA_CFM)
           || leAdvertisingManager_CheckBlockingCondition(ADV_SETUP_BLOCK_ADV_SCAN_RESPONSE_DATA_CFM))
        {
            DEBUG_LOG_LEVEL_2("LeAdvertisingManager_EnableConnectableAdvertising, Data update is in progress while advertising with blocking condition %d",
...
static void leAdvertisingManager_HandleLegacySetAdvertisingEnableCfm(uint16 status)
{
    ...
    if (leAdvertisingManager_CheckBlockingCondition(ADV_SETUP_BLOCK_ADV_ENABLE_CFM))
    {
...
static void leAdvertisingManager_SendReleaseDataSetCfmMessageConditionally(Task task, le_adv_mgr_status_t status)
{
    ...
    DEBUG_LOG_LEVEL_2("leAdvertisingManager_SendReleaseDataSetCfmMessageConditionally Info, Task is %x, status is %x", task, status);
...
static bool leAdvertisingManager_UpdateParameters(uint8 index)
{
    ...
    if((index != adv_task_data->params_handle->active_params_set) || (leAdvertisingManager_IsFallbackNeeded()))
    {
        ...
        if(LeAdvertisingManagerSm_IsAdvertisingStarting() || LeAdvertisingManagerSm_IsAdvertisingStarted())
        {
            ...
            if(leAdvertisingManager_IsDataUpdateInProgressWhileAdvertising())
            {
...
bool LeAdvertisingManager_EnableConnectableAdvertising(Task task, bool enable)
{
    ...
    if(leAdvertisingManager_IsDataUpdateInProgressWhileAdvertising())
    {
        DEBUG_LOG_LEVEL_2("LeAdvertisingManager_EnableConnectableAdvertising, Data update in progress");
        leAdvertisingManager_ScheduleInternalEnableConnectableAdvertising(task, enable);
    }
    else
    {
        return leAdvertisingManager_InternalEnableConnectableAdvertising(task, enable);
    }  
...
bool LeAdvertisingManager_AllowAdvertising(Task task, bool allow)
{
    ...
    if(leAdvertisingManager_IsDataUpdateInProgressWhileAdvertising())
    {
        DEBUG_LOG_LEVEL_2("LeAdvertisingManager_AllowAdvertising, Data update in progress");
        leAdvertisingManager_ScheduleInternalAllowAdvertising(task, allow);
    }
    else
    {
        return leAdvertisingManager_InternalAllowAdvertising(task, allow);
    }
...
{    
    ...
    if(leAdvertisingManager_IsDataUpdateInProgressWhileAdvertising())
    {
        DEBUG_LOG_LEVEL_2("LeAdvertisingManager_ReleaseAdvertisingDataSet, Data update in progress");
        leAdvertisingManager_ScheduleInternalReleaseDataset(handle);
    }
    else
    {
        return leAdvertisingManager_InternalReleaseDataset(handle);
    }
...
void leAdvertisingManager_SetBlockingCondition(uint16 condition)
{
    ...
    DEBUG_LOG("leAdvertisingManager_SetBlockingCondition enum:adv_mgr_blocking_state_t:%u->enum:adv_mgr_blocking_state_t:%u",
...
bool leAdvertisingManager_CheckBlockingCondition(uint16 condition)
{
    ...
    DEBUG_LOG("leAdvertisingManager_CheckBlockingCondition enum:adv_mgr_blocking_state_t:%u->enum:adv_mgr_blocking_state_t:%u",
              adv_task_data->blockingCondition, condition);
