...
extern void uiPrompts_SchedulePromptPlay(uint16 prompt_index);
extern void uiPrompts_SchedulePromptPlay1(uint16 prompt_index);
void appPROMPT_active(void)
{
    if(the_prompts.uiprompts_init_finish_flag==TRUE)
        uiPrompts_SchedulePromptPlay(0);
}

void appPROMPT_active1(void)
{
    if(the_prompts.uiprompts_init_finish_flag==TRUE)
        uiPrompts_SchedulePromptPlay1(0);
}

void appPROMPT_inactive(void)
{
    if(the_prompts.uiprompts_init_finish_flag==TRUE)
    uiPrompts_SchedulePromptPlay(1);
}

void appPROMPT_low_bat(void)
{
    uiPrompts_SchedulePromptPlay(2);
}

void appPROMPT_sensor(void)
{
    if(the_prompts.uiprompts_init_finish_flag==TRUE)
    uiPrompts_SchedulePromptPlay1(3);
}

void appPROMPT_1khz0db(void)
{
    if(the_prompts.uiprompts_init_finish_flag==TRUE)
    uiPrompts_SchedulePromptPlay1(4);
}
#endif
