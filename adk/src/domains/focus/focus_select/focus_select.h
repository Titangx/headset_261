...
*/
void FocusSelect_ConfigureAudioSourceTieBreakOrder(const focus_select_audio_tie_break_t *tie_break_prio);
...
*/
void FocusSelect_ConfigureVoiceSourceTieBreakOrder(const focus_select_voice_tie_break_t *tie_break_prio);
