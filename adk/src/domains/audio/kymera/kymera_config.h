...
#if (defined QCC3020_FF_ENTRY_LEVEL_AA) || (defined QCC5141_RDP)
...
/*! When the primary/secondary perform the A2DP synchronised unmute start
    procedure, this configuration sets the number of samples for the
    mute->unmute transition.
*/
#define appConfigA2dpSyncUnmuteTransitionSamples() 1000
...
#if defined (ENABLE_MULTIPOINT)
#define aptxAdaptiveTTPLatencyAdjustLL() 15
#elif defined(INCLUDE_STEREO)
