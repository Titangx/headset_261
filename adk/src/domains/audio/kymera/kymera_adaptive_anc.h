...
/*! \brief Reconfigure AANC to Standalone when SCO got disconnected, if AANC is enabled by user before
*/
#if defined ENABLE_ADAPTIVE_ANC && !defined INCLUDE_MIC_CONCURRENCY
void KymeraAdaptiveAnc_ReconfigureAancOnScoStop(void);
#else
#define KymeraAdaptiveAnc_ReconfigureAancOnScoStop() ((void)(0))
#endif
