...
{
    UNUSED(params);
    ChainLoadDownloadableCapsFromChainConfig(Kymera_GetChainConfigs()->chain_output_volume_config);
    ChainLoadDownloadableCapsFromChainConfig(Kymera_GetChainConfigs()->chain_prompt_decoder_no_iir_config);
}

void Kymera_UnloadDownloadableCapsForPrompt(const void *params)
{
    UNUSED(params);
    ChainUnloadDownloadableCapsFromChainConfig(Kymera_GetChainConfigs()->chain_output_volume_config);
    ChainUnloadDownloadableCapsFromChainConfig(Kymera_GetChainConfigs()->chain_prompt_decoder_no_iir_config);
}
