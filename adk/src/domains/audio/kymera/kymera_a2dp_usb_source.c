...
#define MIN_LATENCY 40/*! in milli-seconds */
#define MAX_LATENCY 100/*! in milli-seconds */
#define TARGET_LATENCY 80 /*! in milli-seconds */
...
static void KymeraA2dpUsbSource_CreateInputChain(kymeraTaskData *theKymera, uint8 seid)
{
    ...
    switch (seid)
    {
        ...
        case AV_SEID_APTX_ADAPTIVE_SRC:
        {
            ...
            config = Kymera_GetChainConfigs()->chain_input_usb_aptx_encode_config;
            break;
        }
        default:
            Panic();
