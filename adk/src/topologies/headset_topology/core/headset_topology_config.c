...
static const bredr_scan_manager_scan_parameters_set_t hs_page_scan_params_set[] =
{
    {
        {
            [SCAN_MAN_PARAMS_TYPE_SLOW] = { .interval = US_TO_BT_SLOTS(1280000), .window = US_TO_BT_SLOTS(11250) },
            [SCAN_MAN_PARAMS_TYPE_FAST] = { .interval = US_TO_BT_SLOTS(100000),  .window = US_TO_BT_SLOTS(11250) },
            [SCAN_MAN_PARAMS_TYPE_THROTTLE] = { .interval = US_TO_BT_SLOTS(400000), .window = US_TO_BT_SLOTS(2500) },
        },
    },
};
