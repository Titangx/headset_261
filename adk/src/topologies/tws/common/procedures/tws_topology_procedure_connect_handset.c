                                        ...
                                        Message goal_data)
{
    ...
    if (appDeviceGetHandsetBdAddr(&td->handset_addr))
    {
        ...
        HandsetService_ReconnectRequest(TwsTopProcConnectHandsetGetTask(), &td->handset_addr, td->profiles_requested);
...
void TwsTopology_ProcedureConnectHandsetCancel(procedure_cancel_cfm_func_t proc_cancel_cfm_fn)
{
    ...
    HandsetService_StopReconnect(TwsTopProcConnectHandsetGetTask(), &td->handset_addr);
}
